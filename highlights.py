...
# WHILE he's gaming takes minutes. Anything bigger is left on the PC and he's
# told where it is, rather than pretending to send it.
MAX_SEND_MB = 20
...
def save(reason: str = "", send: bool = False, seconds: int = SECONDS) -> str:
    ...
    # H.264 where the codec exists: the same 30 seconds came out 29MB as
    # mp4v and about a fifth of that as avc1. mp4v stays as the fallback so a
    # machine without it still gets a clip.
