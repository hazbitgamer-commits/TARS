"""'The person in the white shirt is the owner' — TARS learns the face in view."""
import sys
...
DESCRIPTION = ("LEARN a face through the camera and attach a name: 'the person in the "
               "white shirt is the owner', 'this is my mate Luke', 'the girl in the "
...
def run(args: dict) -> str:
    ...
    for junk in ("Hey Tars", "Tars,", "Tars"):  # "That's me, TARS. I'm the owner."
